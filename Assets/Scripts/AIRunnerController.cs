...
public class AIRunnerController : MonoBehaviour
{
    ...
    [SerializeField] private Vector2Int gridWorldSize = new Vector2Int(20, 20);
    ...
    void FindPath()
    {
        ...
        Debug.Log($"Start Node: {(startNode != null ? $"({startNode.gridX},{startNode.gridY})" : "NULL")}");
        Debug.Log($"Target Node: {(targetNode != null ? $"({targetNode.gridX},{targetNode.gridY})" : "NULL")}");
